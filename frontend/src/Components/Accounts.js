...
async function selectUser(id, userType, setData) {
  ...
  let submitLink = `https://full-stack-rideshare.vercel.app/api/accountinfo/${submitRole}/none/0/${id}/none`;
  const getUser = async () => {
    try {
...
async function submitUser(props) {
  ...
  let submitLink = `https://full-stack-rideshare.vercel.app/api/accountinfo/${submitRole}/${name}/${date}/1/None`;
...
function Accounts() {
  ...
  let text = `https://full-stack-rideshare.vercel.app/api/accountinfo/${data.role}`;
  useEffect(() => {
